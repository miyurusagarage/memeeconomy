                ...
                <form action="/investmeme" method="get" id="investSubmitForm">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="col-sm-12">
                                <p>You have <strong><span name="availableFlurbos">{{ .user.CurrentCredit }}</span>
                                    Flurbos</strong></p>
                                ...
                                <div class="form-group">
                                    ...
                                    <p class="text-warning" style="display: none;" id="flurbowarning">Insufficient
                                        flurbos! Enter a value less than <span name="availableFlurbos">{{ .user.CurrentCredit }}</span>
                                    </p>
                                </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary btn-simple " id="btn-submit-investment">Submit
                                Investment
                            </button>
